...
export default function EmployeeDashboardPage() {
  ...
  // =====================================================
  // fetchDashboardData - UPDATED FOR SUPABASE
  // =====================================================
  ...
  const fetchDashboardData = useCallback(async () => {
    try {
      ...
      // ✅ Extract leaves from employee data
  ...
  }, [employeeId, calculateStats, calculateDailyAttendanceStatus]) // ✅ Removed supabase dependency
