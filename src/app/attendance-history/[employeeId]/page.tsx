...
export default function AttendanceHistoryPage() {
  ...
  // =====================================================
  // USE EFFECT - generateAttendanceData
  // =====================================================
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-white shadow-sm p-4">
                ...
                <div className="text-xs text-gray-500">{employee.position || 'N/A'}</div>
              </div>
              <div className="bg-white shadow-sm p-4">
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <Phone className="w-4 h-4 text-[#0071BD]" />
                ...
                <div className="text-xs text-gray-500">{employee.cnic_number || 'N/A'}</div>
              </div>
              <div className="bg-white shadow-sm p-4">
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <Calendar className="w-4 h-4 text-[#0071BD]" />
